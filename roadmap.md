...
- [x] Match the admin homepage Transactions table to the supplied finance-table reference
- [x] Add filtering, summaries, sorting, date grouping, pagination, and reconciliation detail
- [x] Validate the redesigned transaction workflow in the live preview
